...
Ｐ174-176の文字列で利用出来るメソッドをよく呼んで以下の問題を解いて下さい。
...
1. address1 から tokyo という単語を探して下さい
...
1. name1 が Swarbrick で始まっているかBooleanで返して下さい
1. name1 が 前から数えて７番目で、Sw で始まっているかBooleanで返して下さい
